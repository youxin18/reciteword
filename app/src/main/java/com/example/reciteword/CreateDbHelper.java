...
public class CreateDbHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_RECITE="create table recite("+"username text primary key autoincrement,"+"username text ,"+"word text ,"+"pron text,"+"definition text)";
